                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('profile.update') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('gender') is-invalid @enderror" id="gender" name="gender" required>
                                        ...
                                        <option value="male" {{ old('gender', $member->gender) == 'male' ? 'selected' : '' }}>男性</option>
                                        <option value="female" {{ old('gender', $member->gender) == 'female' ? 'selected' : '' }}>女性</option>
                                        <option value="other" {{ old('gender', $member->gender) == 'other' ? 'selected' : '' }}>其他</option>
                                    </select>
                                    @error('gender')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="id_number" class="form-label">身份證字號 <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control @error('id_number') is-invalid @enderror" 
                                           id="id_number" name="id_number" value="{{ old('id_number', $member->id_number) }}" 
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="password" class="form-control" 
                                           id="new_password_confirmation" name="new_password_confirmation" minlength="6">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary" style="background-color: #3AC0D2; border-color: #3AC0D2;">
