        ...
        <div class="card shadow-sm border-0">
            <div class="card-body p-5">
                ...
                <div class="row g-0">
                    ...
                    <!-- or -->
                    <div class="col-md-6 ps-md-4 pt-4 pt-md-0 d-flex flex-column align-items-center justify-content-center">
                        <div class="w-100 mb-3">
                            <button class="btn btn-light w-100 mb-2 border d-flex align-items-center justify-content-center" type="button" disabled>
                            ...
                            <button class="btn btn-light w-100 border d-flex align-items-center justify-content-center" type="button" disabled>
                ...
                <div id="signup-section" class="mt-4" style="display:none;">
                    ...
                    <form method="POST" action="{{ url('/signup') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="signupName" name="name" value="{{ old('name') }}" required>
                            @error('name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="mb-3">
                            <label for="signupEmail" class="form-label">Email</label>
                            <input type="email" class="form-control @error('email') is-invalid @enderror" id="signupEmail" name="email" value="{{ old('email') }}" required>
                            @error('email')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="mb-3">
                            <label for="signupPassword" class="form-label">Password</label>
                            <input type="password" class="form-control @error('password') is-invalid @enderror" id="signupPassword" name="password" required>
                            @error('password')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="text-center mt-3">
                        已經有帳號了嗎？<a href="#" id="show-login" class="fw-bold text-decoration-underline">Sign in</a>
                    </div>
                </div>
            </div>
        </div>
