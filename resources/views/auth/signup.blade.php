...
<div class="d-flex justify-content-center align-items-center" style="min-height: 80vh;">
    <div class="card shadow-sm p-4" style="max-width: 400px; width: 100%;">
        ...
        <form method="POST" action="{{ url('/signup') }}">
            ...
            <div class="mb-3">
                <label for="signupPasswordConfirmation" class="form-label">確認密碼 <span class="text-danger">*</span></label>
                <input type="password" class="form-control" id="signupPasswordConfirmation" name="password_confirmation" required>
            </div>
            <button type="submit" class="btn btn-success w-100 mb-2" style="font-weight:500; font-size:1.1rem;">立即註冊</button>
            <hr>
