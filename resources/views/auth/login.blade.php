    ...
    <div class="card shadow-sm p-4" style="max-width: 400px; width: 100%;">
        ...
        <form method="POST" action="{{ url('/login') }}">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control @error('email') is-invalid @enderror" id="loginEmail" name="email" value="{{ old('email') }}" required autofocus placeholder="name@example.com">
            ...
            <button type="submit" class="btn btn-primary w-100 mb-2" style="font-weight:500; font-size:1.1rem;">立即登入</button>
            <hr>
