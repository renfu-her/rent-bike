                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="card h-100 shadow-sm">
                                    @if ($order->bike && $order->bike->image)
                                        <img src="{{ asset('storage/' . $order->bike->image) }}" class="card-img-top"
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <div class="mb-3">
                                            <p class="card-text mb-1">
                                                <strong>訂單編號：</strong>
                                                <span
                                                    class="text-primary fw-bold">{{ $order->order_number ?? 'N/A' }}</span>
                                            </p>
                                            <p class="card-text mb-1">
                                                <strong>租賃方案：</strong>
                                            ...
                                            <p class="card-text mb-1">
                                                <strong>取車門市：</strong>
                                                <span
                                                    class="text-secondary">{{ $order->bike->store->name ?? '未知門市' }}</span>
                                            </p>
                                            <p class="card-text mb-1">
                                                <strong>門市地址：</strong>
                                                <small
                                                    class="text-muted">{{ $order->bike->store->address ?? '未知地址' }}</small>
                                            </p>
                                            <p class="card-text mb-1">
                                                <strong>總金額：</strong>
                                                <span
