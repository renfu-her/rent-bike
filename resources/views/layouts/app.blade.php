                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                                <li><a class="dropdown-item" href="/orders"><i
                                            class="fa-solid fa-motorcycle me-1"></i>我的訂單</a></li>
                                <li><a class="dropdown-item" href="/profile"><i
                                            class="fa-solid fa-user me-1"></i>我的資料</a></li>
                                <li>
                                ...
                                <li>
                                    <form method="POST" action="{{ url('/logout') }}" class="d-inline">
                                        ...
                                        <button type="submit" class="dropdown-item"><i
                                                class="fa-solid fa-right-from-bracket me-1"></i>登出</button>
                                    </form>
                                </li>
                            </ul>
                        </li>
                    @else
                        <li class="nav-item">
                            <a class="nav-link @if (request()->is('login')) active @endif"
                                href="/login?return=/"><i class="fa-solid fa-right-to-bracket me-1"></i>登入</a>
                        </li>
                    @endif
                </ul>
            </div>
